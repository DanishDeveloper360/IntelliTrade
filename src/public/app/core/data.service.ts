...
import { ICustomer, IOrder, IState, IItem , IPagedResults, ICustomerResponse, IItemResponse } from '../shared/interfaces';
...
export class DataService {
    ...
    insertItem(item: IItem) : Observable<IItem> {
        return this.http.post<IItemResponse>(this.baseItemsUrl, item)
                   .map((data) => {
  ...
  getItems() : Observable<IItem[]> {
        return this.http.get<IItem[]>(this.baseItemsUrl)                  
                   .catch(this.handleError);
    }
